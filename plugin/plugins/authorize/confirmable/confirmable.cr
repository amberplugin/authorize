...
module Authorize::Models
  ...
  module Confirmable
    ...
    def confirmation_period_valid?
      return true if Authorize.configuration.allow_unconfirmed_access_for.nil?
      return false if Authorize.configuration.allow_unconfirmed_access_for == 0.days

      allow_unconfirmed_access_for = Authorize.configuration.allow_unconfirmed_access_for
